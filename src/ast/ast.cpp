...
// void print_tree(Node* node, std::string prefix, std::string ident, bool print_bar, bool flag) {
//     assert(node != nullptr);
//     bool print_bar_local=false;
//     if(print_bar){
//         fmt::print(prefix);
//     }
//     bool print_son=false;
...
//         NonTerminalNode* n=static_cast<NonTerminalNode*>(node);
//         for(int i=0;i<n->sons.size();i++){
//             bool np_next = need_print(n->sons[i]);
//             if(i!=n->sons.size()-1){
//                 if (np_next){
//                     print_tree(n->sons[i], ident + "├─ ", ident + "│  ", true, true);
//                 }
//                 else{
//                     print_tree(n->sons[i], ident, ident, false, true);
//                 }
//             }else{
//                 if (np_next){
//                     if (flag){
//                         print_tree(n->sons[i], ident + "├─ ", ident + "│  ", true, flag);
//                     }
//                     else{
//                         print_tree(n->sons[i], ident + "└─ ", ident + "   ", true, flag);
//                     }
//                 }
//                 else{
//                     print_tree(n->sons[i], ident, ident, false, false);
//                 }
//             }
//         }
//     }
